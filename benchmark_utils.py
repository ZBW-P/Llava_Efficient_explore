...
# stress_results_seq = stress_test_sequence_length(
#     model, processor, image, lengths=[128, 512, 2048, 4096]
# )

# test_images = load_images_from_urls(HF_TEST_IMAGES[:8])
# test_prompts = ["Describe this image."] * len(test_images)

# stress_results_bs = stress_test_batch_size(
#     model, processor, test_images, test_prompts, batch_sizes=[1, 2, 4, 8]
# )


# img_list = load_images_from_urls(HF_TEST_IMAGES[:10])

# acc_results = accuracy_test(
#     model,
#     processor,
#     img_list,
#     method_name="Method 2 (INT4 + Channel Prune + KV Quant)"
# )