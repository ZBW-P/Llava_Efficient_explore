...
def kv_TRY():
    ...
    print("\nkv_cache Results:")
    print(f"  Average Latency: {results['avg_total_time']:.3f} seconds")
    print(f"  Average Throughput: {results['avg_throughput']:.2f} tokens/sec")
